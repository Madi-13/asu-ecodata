...
export default {
    ...
    value: {
      handler(newValue) {
        ...
        this.selected = this.options.find(
          (el) => el[this.optionValueField] == newValue
        )
      },
      immediate: true
    },
    options: {
      handler(newValue) {
        this.selected = newValue.find(
          (el) => el[this.optionValueField] == this.value
        )
      }
    }
  },
  ...
  methods: {
    ...
    onSelectValue(option) {
      ...
      this.$emit('input', option[this.optionValueField])
      this.$emit('selected', option[this.optionValueField])
    }
  }
}
</script>
